...
|:---:|---|---|
| Windows | [Urbans-Cannon-1.0-Windows-Setup.exe](https://github.com/MenzrbowstringS/Urban-s-Cannon-VPS-Deployer/releases/latest/download/Urbans-Cannon-1.0-Windows-Setup.exe) | v1.0.6 |
